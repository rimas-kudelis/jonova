...
https://github.com/fonttools/fontbakery/blob/31970cdc5807c3b75c2f9b6e223aca57ffda535f/Lib/fontbakery/legacy_checkids.py
...
<details><summary>[22] Jonova-BoldItalic.ttf</summary>
<div>
<details>
...
<tbody>
<tr>
<td align="left">Some auxiliary glyphs were missing: Ʒ, Ǥ, ǥ, Ǯ, ẞ</td>
...
<details>
    <summary>🔥 <b>FAIL</b> Name table strings must not contain the string 'Reserved Font Name'. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/googlefonts.html#googlefonts-name-rfn">googlefonts/name/rfn</a></summary>
    <div>
...
<p>Width = 1600:
uni220B, uni2208, uni220C, uni2209, uni2238</p>
<p>Width = 1344:
uni221D</p>
<p>Width = 2048:
uni221F</p>
<p>Width = 1024:
uni223D, uni2248, uni224B, uni223C</p>
 [code: width-outliers]
...
<pre><code>* uniEFF3 (U+EFF3): L&lt;&lt;242.0,618.0&gt;--&lt;279.0,662.0&gt;&gt; has the same coordinates as a previous segment.

* uniEFF2 (U+EFF2): L&lt;&lt;276.0,662.0&gt;--&lt;242.0,618.0&gt;&gt; has the same coordinates as a previous segment.
</code></pre>
...
* ⚠️ **WARN** <p>OS/2.sTypoAscender value should be greater than 2048, but got 2012 instead</p>
 [code: typoAscender]
...
<li>U+0305 COMBINING OVERLINE: try adding one of: elbasan, math, coptic, glagolitic, gothic</li>
<li>U+0306 COMBINING BREVE: try adding one of: tifinagh, old-permic</li>
<li>U+0307 COMBINING DOT ABOVE: try adding one of: duployan, hebrew, math, coptic, syriac, tai-le, canadian-aboriginal, old-permic, malayalam, todhri, tifinagh</li>
...
<li>U+0331 COMBINING MACRON BELOW: try adding one of: sunuwar, caucasian-albanian, syriac, tifinagh, thai, cherokee, gothic</li>
...
<li>U+2010 HYPHEN: try adding one of: syloti-nagri, hebrew, kharoshthi, sora-sompeng, lisu, yi, coptic, kaithi, armenian, arabic, cham, sundanese, kayah-li</li>
...
<details><summary>[21] Jonova-Regular.ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Ensure the font supports case swapping for all its glyphs. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#case-mapping">case_mapping</a></summary>
    <div>
...
* ⚠️ **WARN** <p>This check inspects the glyph outlines and detects the total number of contours in each of them. The expected values are infered from the typical ammounts of contours observed in a large collection of reference font families. The divergences listed below may simply indicate a significantly different design on some of your glyphs. On the other hand, some of these may flag actual bugs in the font such as glyphs mapped to an incorrect codepoint. Please consider reviewing the design and codepoint assignment of these to make sure they are correct.</p>
<p>The following glyphs do not have the recommended number of contours:</p>
<pre><code>- Glyph name: uni2569	Contours detected: 2	Expected: 3
</code></pre>
 [code: contour-count]
...
* ⚠️ **WARN** <p>The following glyphs have overlapping path segments:</p>
<pre><code>* uniF8FF (U+F8FF): L&lt;&lt;768.0,1381.0&gt;--&lt;918.0,1381.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;918.0,1381.0&gt;-&lt;1002.0,1381.0&gt;-&lt;1081.5,1358.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1081.5,1358.0&gt;-&lt;1161.0,1335.0&gt;-&lt;1231.5,1293.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1231.5,1293.5&gt;-&lt;1302.0,1252.0&gt;-&lt;1361.0,1193.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1361.0,1193.5&gt;-&lt;1420.0,1135.0&gt;-&lt;1462.5,1064.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1462.5,1064.5&gt;-&lt;1505.0,994.0&gt;-&lt;1528.5,913.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1528.5,913.5&gt;-&lt;1552.0,833.0&gt;-&lt;1552.0,746.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1552.0,746.0&gt;-&lt;1552.0,614.0&gt;-&lt;1500.0,498.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1500.0,498.5&gt;-&lt;1448.0,383.0&gt;-&lt;1360.0,297.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1360.0,297.5&gt;-&lt;1272.0,212.0&gt;-&lt;1157.5,162.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1157.5,162.5&gt;-&lt;1043.0,113.0&gt;-&lt;918.0,113.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): L&lt;&lt;918.0,113.0&gt;--&lt;625.0,113.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): L&lt;&lt;625.0,113.0&gt;--&lt;625.0,164.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): L&lt;&lt;625.0,164.0&gt;--&lt;918.0,164.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;918.0,164.0&gt;-&lt;998.0,164.0&gt;-&lt;1072.5,185.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1072.5,185.0&gt;-&lt;1147.0,206.0&gt;-&lt;1212.0,243.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1212.0,243.5&gt;-&lt;1277.0,281.0&gt;-&lt;1330.0,334.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1330.0,334.5&gt;-&lt;1383.0,388.0&gt;-&lt;1421.0,452.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1421.0,452.5&gt;-&lt;1459.0,517.0&gt;-&lt;1480.0,591.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1480.0,591.5&gt;-&lt;1501.0,666.0&gt;-&lt;1501.0,746.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1501.0,746.0&gt;-&lt;1501.0,866.0&gt;-&lt;1455.0,972.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1455.0,972.0&gt;-&lt;1409.0,1078.0&gt;-&lt;1329.5,1157.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1329.5,1157.5&gt;-&lt;1250.0,1237.0&gt;-&lt;1144.0,1283.5&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): B&lt;&lt;1144.0,1283.5&gt;-&lt;1038.0,1330.0&gt;-&lt;918.0,1330.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): L&lt;&lt;918.0,1330.0&gt;--&lt;768.0,1330.0&gt;&gt; has the same coordinates as a previous segment.

* uniF8FF (U+F8FF): L&lt;&lt;768.0,1330.0&gt;--&lt;768.0,1381.0&gt;&gt; has the same coordinates as a previous segment.

* uniEFF3 (U+EFF3): L&lt;&lt;242.0,618.0&gt;--&lt;279.0,662.0&gt;&gt; has the same coordinates as a previous segment.
...
<details><summary>[21] Jonova-Italic.ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Ensure the font supports case swapping for all its glyphs. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#case-mapping">case_mapping</a></summary>
    <div>
...
* ⚠️ **WARN** <p>The following glyphs have overlapping path segments:</p>
<pre><code>* uniEFF3 (U+EFF3): L&lt;&lt;362.0,618.0&gt;--&lt;399.0,662.0&gt;&gt; has the same coordinates as a previous segment.

* uniEFF2 (U+EFF2): L&lt;&lt;396.0,662.0&gt;--&lt;362.0,618.0&gt;&gt; has the same coordinates as a previous segment.
</code></pre>
 [code: overlapping-path-segments]
...
<details><summary>[23] Jonova-Bold.ttf</summary>
<div>
<details>
    <summary>🔥 <b>FAIL</b> Ensure the font supports case swapping for all its glyphs. <a href="https://fontbakery.readthedocs.io/en/stable/fontbakery/checks/universal.html#case-mapping">case_mapping</a></summary>
    <div>
